...
def get_admin_authentication_token(admin):
    ...
    return {"admin_access_token":admin_access_token , "admin_refresh_token":admin_refresh_token}

def save_token(token):
    
    admin_auth_token_serializer = AdminAuthTokenSerializer(data={"access_token": token["admin_access_token"],"refresh_token":token["admin_refresh_token"]})
